...
public class UserService {
	...
	public static Sysadmin login(String adminName, String pwd) throws SQLException {
		...
		Map<String, Object> m = SysadminDAO.selectOne(sql, adminName, pwd);
...
//		System.out.println(updateUserInfo("张不亮", "BL", "123456", false, 2));
		
		System.out.println(login("ying", "123456"));
	}
}