<%@ page language="java" contentType="text/html; charset=UTF-8" import="xdd.ben.*, java.util.List"
    pageEncoding="UTF-8"%>
...
<body>
	...
	<div class="main">
		...
		<div class="bottom">
			<p>copyright © wei shuang shuang.wisezone ltd.</p>
		</div>
	</div>
